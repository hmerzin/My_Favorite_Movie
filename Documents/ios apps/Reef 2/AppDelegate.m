...
- (void)application:(UIApplication *)application didReceiveRemoteNotification:(NSDictionary *)userInfo  {
    ...
    if(([GlobalPool sharedObject].posted_photos != nil && [GlobalPool sharedObject].posted_photos.count > 9) || [GlobalPool sharedObject].isTop || [GlobalPool sharedObject].isNothing) {
        
        NSString * message = [[userInfo objectForKey:@"aps"] objectForKey:@"alert"];
        
        UIAlertView * alertview = [[UIAlertView alloc] initWithTitle:@"Reef" message:message delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
        [alertview show];
    }
}

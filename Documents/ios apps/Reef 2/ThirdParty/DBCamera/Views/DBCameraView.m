...
- (void) createGesture
{
    ...
    _doubleTap = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector( switchCameraFromDoubleTap: )];
...
- (void)switchCameraFromDoubleTap:(UITapGestureRecognizer *) gesture    {

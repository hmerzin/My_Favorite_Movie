...
#define APP_FULL_NAME           @"Reef for iPhone"

#define APP_VERSION             @"1.00"
#define ITUNES_APP_ID           @"1080661965"
...
#define SHARE_TEXT              @"reef is amazing photo sharing app. Please download from app store and enjoy! \r\nhttps://itunes.apple.com/us/app/reefforiphone/1080661965?ls=1&mt=8. verification code is mrr2sjduxi"

#define APP_STORE_LINK          @"hhttps://itunes.apple.com/us/app/reefforiphone/1080661965?ls=1&mt=8"
...
#define SOMETHING_WRONG         @"Internet connection failed. Please try later!"
#define WELCOME_TEXT            @"Welcome to reef. You have registered successfully. Now you can use our app. Please enjoy with all!"

#define REPORT_USER_SUCCESSFULLY @"Report this user successfully!"
#define REPORT_USER_FAILED      @"Report this user failed!"

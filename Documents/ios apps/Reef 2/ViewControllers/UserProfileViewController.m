...
@interface UserProfileViewController ()<MFMailComposeViewControllerDelegate>
...
- (void) reportUser
{
    NSString* strUserName = [dictUserProfileInfo valueForKey:@"username"];
    NSString * emailTitle = [NSString stringWithFormat:@"Report to %@", strUserName];
    
    NSString * messageBody = @"This user's profile contains offensive and inappropriate content";
    NSArray * toRecipents = [NSArray arrayWithObject:@"joshfarahzad@gmail.com"];
...
- (void)mailComposeController:(MFMailComposeViewController *)controller didFinishWithResult:(MFMailComposeResult)result error:(NSError *)error  {
    ...
    switch (result) {
        case MFMailComposeResultCancelled:
            ...
            [g_Delegate AlertWithCancel_btn:REPORT_USER_FAILED];
            break;
        ...
        case MFMailComposeResultSent:
            NSLog(@"Mail sent");
            [g_Delegate AlertWithCancel_btn:REPORT_USER_SUCCESSFULLY];
            break;
